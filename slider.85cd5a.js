		...
		var app = new _Q2.default({
			...
			methods: {
				...
				openSlider: function openSlider(e, type) {
					...
					debugger;
					var nodes = document.querySelector('#header_ul').querySelectorAll('.header_li');
					// nodes = Array.prototype.forEach.call(nodes, 0);
					Array.prototype.forEach.call(nodes, 0)(nodes, function (item, index) {
